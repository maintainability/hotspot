...
public class SvnCommandParserTest {
	...
	public void testParseSourceControlLog() throws IOException {
		...
		assertEquals("VisualSVN Server", result.get(0).getDeveloper());
		...
		assertEquals("VisualSVN Server", result.get(1).getDeveloper());
		...
		assertEquals("user1", result.get(2).getDeveloper());
		...
		assertEquals("user1", result.get(3).getDeveloper());
		...
		assertEquals("user1", result.get(4).getDeveloper());
		...
		assertEquals("user1", result.get(5).getDeveloper());
		...
		assertEquals("user2", result.get(6).getDeveloper());
		...
		assertEquals("user1", result.get(7).getDeveloper());
		...
		assertEquals("user1", result.get(8).getDeveloper());
		...
		assertEquals("user1", result.get(9).getDeveloper());
		...
		assertEquals("user2", result.get(10).getDeveloper());
		assertEquals("Rename.\n", result.get(10).getComment());
		assertEquals(OperationType.R, result.get(10).getCommitedFiles().get(0).getOperationType());
		...
		assertEquals("user1", result.get(11).getDeveloper());
		...
		assertEquals("user1", result.get(12).getDeveloper());
